...
open class SwiftyBeaverKit {
    ...
    public class func custom(level: SwiftyBeaverKit.Level, message: @autoclosure () -> Any,
    ...
    class func dispatch_send(level: SwiftyBeaverKit.Level, message: @autoclosure () -> Any,
